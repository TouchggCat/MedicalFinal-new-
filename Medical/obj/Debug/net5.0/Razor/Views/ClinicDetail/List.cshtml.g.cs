#pragma checksum "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c78e3b4fd73e296b51a247fabe8106d36d70b5a7"
// <auto-generated/>
...
#nullable disable
    ...
    public class Views_ClinicDetail_List : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<Medical.ViewModel.CClinicDetailViewModel>>
    {
        ...
        {
#nullable restore
#line 2 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
...
");
#nullable restore
#line 17 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
...
#nullable disable
            ...
            <div class=""bg-primary d-flex flex-column p-5"" style=""height: 300px; width: auto; border-radius: 15%"">
                <h2>診間:  ");
#nullable restore
#line 25 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
            ...
            WriteLiteral(@"</h2>
                ...
                <div class=""d-flex justify-content-between text-white mb-3"">
                    ...
                    <p class=""mb-0"">
                        ");
#nullable restore
#line 32 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
            ...
            WriteLiteral(@"
                ...
                <div class=""d-flex justify-content-between text-white mb-3"">
                    ...
                    <p class=""mb-0"">
                        ");
#nullable restore
#line 40 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
            ...
            WriteLiteral(@"
                ...
                <div class=""d-flex justify-content-between text-white mb-3"">
                    ...
                    <h1 class=""mb-0"" style=""color:red;font-size:larger"">
                        ");
#nullable restore
#line 48 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
...
#nullable disable
            WriteLiteral("\r\n                    </h1>\r\n                </div>\r\n            </div>\r\n        </div>\r\n");
#nullable restore
#line 53 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
            }
        }
...
#nullable restore
#line 61 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
                                                                                                           Write(ViewBag.Time);
...
");
#nullable restore
#line 76 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
                     foreach(var item in Model)
                    {
                        string online = "";
                        if (item.Online == 0)
...
#nullable restore
#line 88 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
                                                                                                                                           Write(item.Room.RoomName);
...
#nullable restore
#line 89 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
                                                                                                     Write(item.Doctor.DoctorName);
...
#nullable restore
#line 90 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
                       Write(item.Department.DeptName);
...
#nullable restore
#line 92 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
...
#nullable restore
#line 95 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
                                                                                                                                                                 Write(item.Room.Number);
...
#nullable disable
            WriteLiteral("</font></font></div>\r\n                        </td>\r\n                    </tr>\r\n");
#nullable restore
#line 98 "C:\ADO.NET\作業區\Medical-final-3.0\Medical\Views\ClinicDetail\List.cshtml"
                    }
